...
2) Instsll Visual Studio 2012 (cause that's what the solution will open in).
...
6) Install OpenAl. MonoDevelop puts the installer here by default C:\Program Files (x86)\MonoGame\v3.0\oalinst.exe
